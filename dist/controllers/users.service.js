...
var UsersDataService = /** @class */ (function () {
    ...
    UsersDataService.prototype.getUser = function (key) {
        return db.child(key);
    };
    ...
    UsersDataService.prototype.updateUser = function (key, value) {
        return db.child(key).update(value);
    };
    UsersDataService.prototype.deleteUser = function (key) {
        return db.child(key).remove();
    };
    UsersDataService.prototype.deleteAllUsers = function () {
        return db.remove();
    };
    return UsersDataService;
}());
exports["default"] = new UsersDataService();
// let users: Users = {
//     1: {
//         uid: 1,
//         firstName: "Tushar",
