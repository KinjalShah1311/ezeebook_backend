...
var users_service_1 = require("../controllers/users.service");
...
exports.userRouter.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_service_1["default"].getAllUsers()];
            case 1:
                users = _a.sent();
                if (!users) {
...
exports.userRouter.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, users_service_1["default"].getUser(id)];
            case 2:
                user = _a.sent();
                if (user) {
...
exports.userRouter.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var baseUser, user, newUser, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                baseUser = req.body;
                user = __assign({}, baseUser);
                return [4 /*yield*/, users_service_1["default"].createUser(user)];
            case 1:
                newUser = _a.sent();
...
exports.userRouter.put("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, userUpdate, existingUser, updatedUser, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
            ...
            case 2:
                ...
                return [4 /*yield*/, users_service_1["default"].updateUser(id, userUpdate)];
            case 3:
                updatedUser = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, users_service_1["default"].deleteUser(id)];
            case 1:
                _a.sent();
                res.sendStatus(204);
                return [3 /*break*/, 3];
